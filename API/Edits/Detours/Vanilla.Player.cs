...
namespace AARPG.API.Edits.Detours{
	internal static partial class Vanilla{
		internal static void Player_KillMe(Terraria.On_Player.orig_KillMe orig, Player self, Terraria.DataStructures.PlayerDeathReason damageSource, double dmg, int hitDirection, bool pvp){
