...
namespace AARPG.API.UI{
	//Stealing's only illegal if the cops find you!
	// https://github.com/NotLe0n/Creativetools/blob/1.4_GameInfo2/src/UI/Elements/BetterUIList.cs
	public class BetterUIList : UIList{
